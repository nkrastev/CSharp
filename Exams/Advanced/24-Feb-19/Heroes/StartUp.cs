...
namespace Heroes
{
    class StartUp
    {
        static void Main(string[] args)
        {
            ...
            //Console.WriteLine($"Hightest strenght {heroStrength.Name}");

            Hero heroAbility = repository.GetHeroWithHighestAbility(); // Hero with name Hero Name
            //Console.WriteLine($"Hightest Ability {heroAbility.Name}");
            
            Hero heroIntelligence = repository.GetHeroWithHighestIntelligence(); // Hero with name Hero
            //Console.WriteLine($"Hightest Intelligence {heroIntelligence.Name}");
